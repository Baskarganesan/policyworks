...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Policyworks — Insurance Policy Intelligence" },
      { name: "description", content: "AI-powered insurance policy intelligence, claims and customer operations." },
      { name: "author", content: "Policyworks" },
      { property: "og:title", content: "Policyworks — Insurance Policy Intelligence" },
